...
"crops":{"title":"Crops (Wheat & Vegetables)","glyph":"❦","col":"#5a9c88",
 ...
 "body":[
  ...
  {"p":"For crops that don't replant from their own drops, swap the harvester for two [[create:deployer|Deployers]] on the arm: one holding a hoe or bone meal, one holding seeds. This needs brass, so it's a second-generation upgrade — the rotating harvester above gets you farming long before then."}]},

"iron":{"title":"Iron & Ore Doubling","glyph":"▬","col":"#d8d8d8",
 "sub":"Crushing wheels + wash","yields":"Double nuggets from every ore",
 "lede":"The biggest single yield jump available early. Every ore you feed through [[create:crushing_wheel|Crushing Wheels]] comes out roughly doubled — and washing the results squeezes out even more.",
 "body":[
  {"h":"Building the wheels"},
  {"p":"[[create:crushing_wheel|Crushing Wheels]] have no crafting-table recipe — the only way to build them is Mechanical Crafting, covered in <b>Starter Machines</b>. Build two, place them facing each other, and make sure they counter-rotate; if nothing happens when powered, one is backwards, so flip it with a [[create:wrench|Wrench]]."},
  {"h":"The doubling line"},
  {"steps":[
   {"b":"Drop raw ore in from above onto a belt running between the wheels","t":"The wheels grab items off the belt, crush them, and spit crushed ore out the far side — roughly double the nuggets per ore."},
   {"b":"Wash the crushed ore","t":"Run it past an [[create:encased_fan|Encased Fan]] blowing through a column of water. Washing crushed ore yields extra nuggets on top of the doubling, plus the occasional bonus drop."},
   {"b":"Smelt in bulk","t":"An [[create:encased_fan|Encased Fan]] blowing through fire or lava smelts everything on a belt behind it, in parallel, for the cost of one machine — it replaces a whole furnace array."},
   {"b":"Collect the ingots","t":"A funnel at the end of the smelting belt into your iron chest, ready for the [[create:packager|logistics network]] or the next machine."}]},
  {"note":"This same line doubles every metal in the pack, not just iron — copper, zinc, gold and the modded ores all go through the identical crush → wash → smelt path. Build it once and route every ore type through it."},
  {"warn":"A [[create:blaze_burner|Blaze Burner]] under a lava-fan smelter must stay fed, and a fan smelter behind a mob of items can back up if the output chest fills. Latch the input so it stops when there's nowhere for the ingots to go."}]},
...
"tree":{"title":"Tree Farm","glyph":"▥","col":"#8a6f1c",
 ...
 "body":[
  ...
  {"h":"Replanting"},
  {"p":"For a farm that never runs dry, add a [[create:deployer|Deployer]] holding saplings to plant behind the cut, and a second holding bone meal to force growth. That needs brass — until then, a large enough ring of natural trees keeps a saw carousel busy for a long time on its own."},
